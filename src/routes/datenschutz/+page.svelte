...
<svelte:head>
	<title>Datenschutz | Karolin Rohmer</title>
</svelte:head>
...
<div class="mt-20 mb-4 max-w-4xl mx-auto px-2">
	...
	<p>
		...
		Kontaktdaten, Namen, Websitezugriffe und sonstige Daten, die &uuml;ber eine Website generiert
		werden, handeln.
	</p>
	<p>
	...
	<p>E-Mail: info@karolinrohmer.com</p>

	<p>Die Anschrift erhalten Sie auf Anfrage.</p>
...
<style lang="postcss">
	...
	h2 {
		@apply text-xl mb-3 mt-10;
	}

	h3 {
		@apply text-lg mb-3 mt-8;
	}

	h4 {
		@apply font-medium mb-2 mt-5;
	}
